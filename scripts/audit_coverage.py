...
REQUIREMENTS: list[tuple[str, str, str]] = [
    ...
    ("Reglement", "Schema d'architecture televersable (png/pdf)",
     "tests/unit/test_contest_compliance.py::test_the_architecture_diagram_is_an_uploadable_file"),
    ("Reglement", "Fiche de soumission coherente avec le code",
     "tests/unit/test_contest_compliance.py::test_the_submission_sheet_declares_a_compliant_model"),
    ...
    ("Doc05 observabilite", "Aucune auto-instrumentation qui casse les requetes",
     "tests/integration/test_cors_and_instrumentation.py::test_fastapi_auto_instrumentation_is_not_enabled"),
    ("Doc05 observabilite", "Le preflight CORS aboutit sur les URLs deployees",
     "tests/integration/test_cors_and_instrumentation.py::test_deployed_frontend_origin_passes_preflight"),
    ("Doc02 flotte", "Chaque outil dispose de sa capacite au registre",
     "tests/unit/test_registry_capabilities.py::test_every_tool_has_its_capability"),
    ("Doc03 securite", "Aucune capacite sans outil (moindre privilege)",
     "tests/unit/test_registry_capabilities.py::test_no_capability_without_a_tool"),
    ("Doc06 demo", "La reinitialisation efface reellement les donnees",
     "tests/integration/test_firestore_reset.py::test_reset_actually_runs_and_empties_everything"),
    ("Doc05 observabilite", "L'interface n'affirme pas un mode qu'elle ignore",
     "tests/unit/test_cost_guardrails.py::test_the_agent_mode_badge_is_not_a_literal"),
    ("Doc04 memoire", "La bascule de fournisseur est ecrite dans le store",
     "tests/integration/test_supplier_switch.py::test_the_switch_lands_in_the_store_not_on_the_callers_object"),
    ("Doc02 flotte", "La bascule de fournisseur atteint reellement la flotte",
     "tests/integration/test_supplier_switch.py::test_the_switch_actually_reaches_the_supply_agent"),
    ("Doc03 securite", "Une approbation peut etre inspectee avant d'etre tranchee",
     "tests/scenarios/test_demo_script.py::test_the_modal_can_be_dismissed_without_deciding"),
    ("Doc06 demo", "L'interface permet l'ordre prescrit par le script",
     "tests/scenarios/test_demo_script.py::test_demo_controls_survive_an_empty_mission_list"),
    ("Doc02 flotte", "Un redeploiement corrige les capacites declarees",
     "tests/integration/test_registry_reconciliation.py::test_capabilities_are_corrected_on_redeploy"),
    ("Doc02 flotte", "Un agent suspendu le reste apres redeploiement",
     "tests/integration/test_registry_reconciliation.py::test_a_suspended_agent_stays_suspended"),
    ("Doc08 idempotence", "Deux taches ne peuvent pas passer deux fois la meme commande",
     "tests/integration/test_double_purchase.py::test_two_tasks_cannot_place_two_identical_orders"),
    ("Doc08 idempotence", "Un achat de repli apres recovery n'est pas deduplique",
     "tests/integration/test_double_purchase.py::test_a_different_supplier_is_a_different_action"),
    ("Doc05 fiabilite", "Un disjoncteur ouvert finit par se refermer",
     "tests/integration/test_circuit_breaker.py::test_an_open_breaker_eventually_closes"),
    ("Doc06 demo", "La reinitialisation fonctionne malgre un disjoncteur ouvert",
     "tests/integration/test_circuit_breaker.py::test_reset_works_even_with_a_tripped_breaker"),
    ("Doc06 demo", "Chaque controle de demo atteint les systemes entreprise",
     "tests/integration/test_demo_controls.py::test_every_demo_control_reaches_the_enterprise_systems"),
    ("Doc06 demo", "Un echec de controle nomme l'etape fautive",
     "tests/integration/test_demo_controls.py::test_a_failing_enterprise_names_the_step"),
    ("Doc06 demo", "La reinitialisation refuse hors mode demo",
     "tests/integration/test_firestore_reset.py::test_reset_is_refused_outside_demo_mode"),
